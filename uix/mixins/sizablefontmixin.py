...
class SizableFontMixin:
    ...
    def calculate_font(text: str, ref_widget: MDWidget, root: MDWidget = Window,
                       length_div: float = UixConfig.TEXT_LENGTH_CORR_DIV,
                       root_width_mlt: float = UixConfig.APP_WIDE_SCR_MULT,
                       base_font_mlt_wide: float = UixConfig.BASE_FONT_MLT_WIDE,
                       base_font_mlt_narrow: float = UixConfig.BASE_FONT_MLT_NARROW, use_txt_corr: bool = True):
